...
const PRODUCTS = [
  ...
  { name: 'Prompt Pad', kind: 'pad', size: 'sm', image: './images/prompt-pad.jpg', desc: 'An 8×8 grid of programmable RGB pads. Pin a model, prompt, snippet or agent to each pad — your whole AI workflow lit up at a glance, one tap away.', tags: ['64 RGB pads', 'USB-C', 'Per-pad presets'], price: '$89', tag: 'Portable', screen: '' },
];
